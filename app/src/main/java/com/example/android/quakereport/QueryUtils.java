    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < earthquakesJSONArray.length(); i++) {
                ...
                earthquakes.add(new Earthquake(currentEarthquakeMagnitude, currentEarthquakeLocation, currentEarthquakeTime));
